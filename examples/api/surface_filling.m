...
gmsh.model.occ.addPoint(-0.8,  0.1, -0.2, 0., 1);
gmsh.model.occ.addPoint(-0.5,  0.1, -0.2, 0., 2);
gmsh.model.occ.addPoint(-0.6,  0,   -0.1, 0., 3);
gmsh.model.occ.addPoint(-0.7, -0,   -0.1, 0., 4);
gmsh.model.occ.addPoint(-0.7,  0.2, -0.2, 0., 5);
gmsh.model.occ.addPoint(-0.6,  0.1, -0.1, 0., 6);
...
gmsh.model.occ.addPoint(-0.7,  0.1, -0.2, 0., 7);
gmsh.model.occ.addPoint(-0.67, 0.1, -0.2, 0., 8);
