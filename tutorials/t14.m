% Gmsh MATLAB tutorial 14 — Homology and cohomology computation.

gmsh.initialize();
gmsh.model.add("t14");

m = 0.5;  % mesh size
h = 2;    % geometry height along z
...
boundary_dimtags = gmsh.model.getBoundary([3 domain_tag], false, false, false);
boundary_tags = boundary_dimtags(:,2).';
complement_tags = setdiff(boundary_tags, terminal_tags, 'stable');

gmsh.model.addPhysicalGroup(2, boundary_tags, 2002, "Boundary");
gmsh.model.addPhysicalGroup(2, complement_tags, 2003, "Complement");
