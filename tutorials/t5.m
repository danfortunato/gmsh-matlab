% Gmsh MATLAB tutorial 5 — Mesh sizes, holes in volumes.
...
shells(end+1) = sl;  %#ok<AGROW>

x = 0; y = 0.75; z = 0; r = 0.09;
for t = 1:5
    x = x + 0.166;
    z = z + 0.166;
    [v, shells] = cheeseHole(x, y, z, r, lcar3, shells);
...
function [v, shells] = cheeseHole(x, y, z, r, lc, shells)
