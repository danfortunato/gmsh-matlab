...
%GETENTITIESINBOUNDINGBOX  gmsh.model.getEntitiesInBoundingBox
...
%     dimTags - Nx2 matrix of (dim,tag) pairs
    ...
    dimTags = gmsh.internal.api.call('gmshModelGetEntitiesInBoundingBox', xmin, ymin, zmin, xmax, ymax, zmax, dim);
end
