...
%SYMMETRIZE  gmsh.model.occ.symmetrize
%   Mirror the entities `dimTags' (given as a vector of (dim, tag) pairs) in the
%   OpenCASCADE CAD representation, with respect to the plane of equation `a' *
...
%     d - double scalar
    ...
    gmsh.internal.api.call('gmshModelOccSymmetrize', dimTags, a, b, c, d);
end
