...
%ROTATE  gmsh.model.occ.rotate
%   Rotate the entities `dimTags' (given as a vector of (dim, tag) pairs) in the
%   OpenCASCADE CAD representation by `angle' radians around the axis of
...
%     angle - double scalar
    ...
    gmsh.internal.api.call('gmshModelOccRotate', dimTags, x, y, z, ax, ay, az, angle);
end
