...
%ADDPOINT  gmsh.model.occ.addPoint
%   Add a geometrical point in the OpenCASCADE CAD representation, at
%   coordinates (`x', `y', `z'). If `meshSize' is > 0, add a meshing constraint
%   at that point. If `tag' is positive, set the tag explicitly; otherwise a new
...
%     ret - integer scalar
    ...
    ret = gmsh.internal.api.call('gmshModelOccAddPoint', x, y, z, meshSize, tag);
end
