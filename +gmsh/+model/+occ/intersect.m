function [outDimTags, outDimTagsMap] = intersect(objectDimTags, toolDimTags, tag, removeObject, removeTool)
...
%   `outDimTagsMap'. If `tag' is positive, try to set the tag explicitly (only
...
%     outDimTagsMap - cell of Nx2 (dim,tag) matrices
    ...
    [outDimTags, outDimTagsMap] = gmsh.internal.api.call('gmshModelOccIntersect', objectDimTags, toolDimTags, tag, removeObject, removeTool);
end
