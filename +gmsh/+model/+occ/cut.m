function [outDimTags, outDimTagsMap] = cut(objectDimTags, toolDimTags, tag, removeObject, removeTool)
...
%     outDimTagsMap - cell of Nx2 (dim,tag) matrices
    ...
    [outDimTags, outDimTagsMap] = gmsh.internal.api.call('gmshModelOccCut', objectDimTags, toolDimTags, tag, removeObject, removeTool);
end
