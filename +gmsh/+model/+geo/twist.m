function outDimTags = twist(dimTags, x, y, z, dx, dy, dz, ax, ay, az, angle, numElements, heights, recombine)
...
%   (cumulative) height of the different layers, normalized to 1. If `recombine'
...
%     outDimTags - Nx2 matrix of (dim,tag) pairs
    ...
    outDimTags = gmsh.internal.api.call('gmshModelGeoTwist', dimTags, x, y, z, dx, dy, dz, ax, ay, az, angle, numElements, heights, recombine);
end
