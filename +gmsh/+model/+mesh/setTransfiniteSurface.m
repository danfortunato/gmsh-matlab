...
%SETTRANSFINITESURFACE  gmsh.model.mesh.setTransfiniteSurface
...
%   the (3 or 4) corners of the transfinite interpolation explicitly; specifying
%   the corners explicitly is mandatory if the surface has more that 3 or 4
...
%     cornerTags - vector of integers (default int32([]))
    ...
    gmsh.internal.api.call('gmshModelMeshSetTransfiniteSurface', tag, arrangement, cornerTags);
end
